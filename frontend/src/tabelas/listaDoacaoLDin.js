...
import { buscarDoacao, excluirDoacao } from '../redux/redutores/DoacaoLDinSlice.js';
...
export default function ListaDoacao(props) {
    ...
    if (statusLDin === STATUS.OCIOSO) {
        ...
        return (
            <Modal.Dialog>
                <Modal.Header>
                    <Modal.Title classname="col-md-5 mx-auto">Tabela de Doação Presencial de Dinheiro</Modal.Title>
                </Modal.Header>
                <Modal.Body>
